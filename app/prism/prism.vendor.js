...
exports.Prism.hooks.add('wrap', function (env) {
    if (env.type === 'entity') {
        env.attributes['title'] = env.content.replace(/&amp;/, '&');
    }
});
exports.Prism.languages.xml = exports.Prism.languages.markup;
exports.Prism.languages.html = exports.Prism.languages.markup;
exports.Prism.languages.mathml = exports.Prism.languages.markup;
exports.Prism.languages.svg = exports.Prism.languages.markup;
exports.Prism.languages.css = {
    'comment': /\/\*[\w\W]*?\*\//,
    'atrule': {
        pattern: /@[\w-]+?.*?(;|(?=\s*\{))/i,
        inside: {
...
exports.Prism.languages.css['atrule'].inside.rest = exports.Prism.util.clone(exports.Prism.languages.css);
if (exports.Prism.languages.markup) {
    exports.Prism.languages.insertBefore('markup', 'tag', {
        'style': {
            pattern: /(<style[\w\W]*?>)[\w\W]*?(?=<\/style>)/i,
            lookbehind: true,
            inside: exports.Prism.languages.css,
            alias: 'language-css'
        }
    });
    exports.Prism.languages.insertBefore('inside', 'attr-value', {
        'style-attr': {
            pattern: /\s*style=("|').*?\1/i,
            inside: {
                'attr-name': {
                    pattern: /^\s*style/i,
                    inside: exports.Prism.languages.markup.tag.inside
                },
                'punctuation': /^\s*=\s*['"]|['"]\s*$/,
                'attr-value': {
                    pattern: /.+/i,
    ...
    }, exports.Prism.languages.markup.tag);
}
;
...
//# sourceMappingURL=../../../dist/app/prism/prism.vendor.js.map