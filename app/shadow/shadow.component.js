...
var ShadowDemo = (function (_super) {
    __extends(ShadowDemo, _super);
    function ShadowDemo(router, route, titleService) {
        _super.call(this, router, route, titleService);
    }
    ShadowDemo = __decorate([
        core_1.Component({
            moduleId: module.id,
...
exports.ShadowDemo = ShadowDemo;
//# sourceMappingURL=../../../dist/app/shadow/shadow.component.js.map